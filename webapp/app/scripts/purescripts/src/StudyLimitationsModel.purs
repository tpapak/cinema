...
instance decodeNetRobModel :: DecodeJson NetRobModel where
  decodeJson json = case toObject json of
    ...
    Just obj -> do
      ...
      sl <- getField obj "studyLimitations"
      pure $ NetRobModel { status: st, studyLimitations: sl }
...
instance decodeStudyLimitations :: DecodeJson StudyLimitations where
  decodeJson json = case toObject json of
    ...
    Just obj -> do
      ...
      pure $ StudyLimitations { customized: c, rule: r, status: st, boxes: b }
...
instance decodeRobRule :: DecodeJson RobRule where
  decodeJson json = case toObject json of
    ...
    Just obj -> do
      ...
      pure $ RobRule { id: i, isActive: ia, label: l, name: n, value: v }
