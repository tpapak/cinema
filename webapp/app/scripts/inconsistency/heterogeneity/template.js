...
//      VText: VText
// });
var heterogeneityView = require('../../views/heterogeneityView.js');
...
var Template = (model,children) => {
  ...
  var data = _.extend(resolveGetters(View(model)), { text: model.getState().text.Heterogeneity });
  return heterogeneityView(data);
}
